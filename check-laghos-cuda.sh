...
# /usr/tce/packages/spectrum-mpi/ibm/spectrum-mpi-rolling-release/lib/pami_noib
# /usr/tce/packages/spectrum-mpi/spectrum-mpi-rolling-release-gcc-11.2.1/lib
# export LD_LIBRARY_PATH=$MNEME_LIBS:$LD_LIBRARY_PATH
